 ...
 */
! function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t(require("angular"), require("moment"), function() {
        try {
            return require("interact.js")
        } catch (e) {}
    }()) : "function" == typeof define && define.amd ? define(["angular", "moment", "interact"], t) : "object" == typeof exports ? exports.angularBootstrapCalendarModuleName = t(require("angular"), require("moment"), function() {
        try {
            return require("interact.js")
        } catch (e) {}
    ...
    return function(e) {
        ...
        l.keys().forEach(function(e) {
        ...
        }), e.exports = r.module("mwl.calendar", []).config(["calendarConfig", function(e) {
            ...
            r.forEach(i, function(n) {
                if (!e.get(n.cacheTemplateName)) {
                    var a = n.template.replace("{{", t.startSymbol()).replace("}}", t.endSymbol());
        ...
        var a = n(2),
            ...
            l = function(e, t, n) {
                ...
                if (e.end) {
                    ...
                    i = a(e.end).endOf("day").add(1, "minute").diff(l.startOf("day"), "days"), i > r && (i = r)
                }
                var d = t + i;
                return d > r && (i -= d - r), i
            };
        t.getDayOffset = function(e, t) {
            var n = 0;
            return a(e.start).startOf("day").isAfter(a(t)) && (n = a(e.start).startOf("day").diff(t, "days")), n
        };
        var d = function(e) {
                var t = e.event,
                    n = e.periodStart,
                    ...
                    i = a(t.start),
                    l = a(t.end || t.start);
                return i.isAfter(n) && i.isBefore(r) ? !0 : l.isAfter(n) && l.isBefore(r) ? !0 : i.isBefore(n) && l.isAfter(r) ? !0 : i.isSame(n) || i.isSame(r) ? !0 : l.isSame(n) || l.isSame(r) ? !0 : !1
            },
            o = function(e) {
                var t = e.events,
                    n = e.periodStart,
        ...
        t.getWeekViewHeader = function(e) {
                ...
                if (-1 === m.indexOf(e)) {
                    ...
                    var n = e.span + e.offset,
                        a = c.slice(t + 1).filter(function(e) {
                            return -1 === m.indexOf(e) && e.offset >= n && n + e.span <= r ? (e.offset -= n, n += e.span + e.offset, m.push(e), !0) : void 0
                        });
                    v.push({
                        row: [e].concat(a)
                    })
            ...
            for (var t = e.events, n = e.viewDate, r = a(n).startOf("month").startOf("week"), i = a(n).endOf("month").endOf("week"), l = o({
                    events: t,
                ...
                m.inMonth = v.clone().startOf("month").isSame(a(n).startOf("month")), m.inMonth ? m.events = o({
                    events: l,
                    periodStart: a(v).startOf("day"),
                    periodEnd: a(v).endOf("day")
                }) : m.events = [], d.push(m)
            }
            for (var u = Math.floor(d.length / 7), f = [], c = 0; u > c; c++) f.push(7 * c);
            return {
                rowOffsets: f,
                days: d
            }
        ...
        "use strict";
        var a = n(1);
        a.module("mwl.calendar").controller("MwlCalendarCtrl", ["$scope", "$log", "$timeout", "$attrs", "$locale", "moment", "calendarTitle", "calendarHelper", function(e, t, n, r, i, l, d, o) {
            function s(e) {
                return e.startsAt ? a.isDate(e.startsAt) || t.warn("Bootstrap calendar: ", "Event startsAt should be a javascript date object. Do `new Date(event.startsAt)` to fix it.", e) : t.warn("Bootstrap calendar: ", "Event is missing the startsAt field", e), e.endsAt && (a.isDate(e.endsAt) || t.warn("Bootstrap calendar: ", "Event endsAt should be a javascript date object. Do `new Date(event.endsAt)` to fix it.", e), l(e.startsAt).isAfter(l(e.endsAt)) && t.warn("Bootstrap calendar: ", "Event cannot start after it finishes", e)), !0
            }

            function c() {
                d[v.view] && a.isDefined(r.viewTitle) && (v.viewTitle = d[v.view](v.viewDate)), v.events = v.events.filter(s).map(function(e, t) {
                ...
                var t = l(v.viewDate),
                    i = !0;
                m.clone().startOf(v.view).isSame(t.clone().startOf(v.view)) && !m.isSame(t) && v.view === u && (i = !1), m = t, u = v.view, i && n(function() {
        ...
        "use strict";
        var a = n(1);
        a.module("mwl.calendar").controller("MwlCalendarDayCtrl", ["$scope", "moment", "calendarHelper", "calendarEventTitle", function(e, t, n, a) {
            function r() {
                i.dayViewSplit = i.dayViewSplit || 30, i.dayViewHeight = n.getDayViewHeight(i.dayViewStart, i.dayViewEnd, i.dayViewSplit);
                var e = n.getDayView(i.events, i.viewDate, i.dayViewStart, i.dayViewEnd, i.dayViewSplit);
            ...
            var i = this;
            i.calendarEventTitle = a, e.$on("calendar.refreshView", r), e.$watchGroup(["vm.dayViewStart", "vm.dayViewEnd", "vm.dayViewSplit"], r), i.eventDragComplete = function(e, n) {
                ...
                var r = a * i.dayViewSplit,
                    l = t(e.startsAt),
                    d = t(e.endsAt);
                "start" === n ? l.add(r, "minutes") : d.add(r, "minutes"), delete e.tempStartsAt, i.onEventTimesChanged({
                    calendarEvent: e,
        ...
        "use strict";
        var a = n(1);
        a.module("mwl.calendar").controller("MwlCalendarHourListCtrl", ["$scope", "$attrs", "moment", "calendarConfig", "calendarHelper", function(e, t, n, a, r) {
            function i() {
                l = n(o.dayViewStart || "00:00", "HH:mm"), d = n(o.dayViewEnd || "23:00", "HH:mm"), o.dayViewSplit = parseInt(o.dayViewSplit), o.hours = [];
                var e = n(o.viewDate).clone();
                t.dayWidth && (e = e.startOf("week")), e.hours(l.hours()).minutes(l.minutes()).seconds(l.seconds());
        ...
        "use strict";
        var a = n(1);
        a.module("mwl.calendar").controller("MwlCalendarMonthCtrl", ["$scope", "moment", "calendarHelper", "calendarConfig", "calendarEventTitle", function(e, t, n, a, r) {
            var i = this;
            i.calendarConfig = a, i.calendarEventTitle = r, i.openRowIndex = null, e.$on("calendar.refreshView", function() {
                i.weekDays = n.getWeekDayNames(), i.view = n.getMonthView(i.events, i.viewDate, i.cellModifier);
                var e = Math.floor(i.view.length / 7);
                i.monthOffsets = [];
                for (var a = 0; e > a; a++) i.monthOffsets.push(7 * a);
                i.cellIsOpen && null === i.openRowIndex && (i.openDayIndex = null, i.view.forEach(function(e) {
                    e.inMonth && t(i.viewDate).startOf("day").isSame(e.date) && i.dayClicked(e, !0)
                }))
                ...
                if (t || (i.onTimespanClick({
                    ...
                    a === i.openDayIndex ? (i.openDayIndex = null, i.cellIsOpen = !1) : (i.openDayIndex = a, i.openRowIndex = Math.floor(a / 7), i.cellIsOpen = !0)
                }
                ...
                var l = t(e.startsAt).date(t(a).date()).month(t(a).month()).year(t(a).year()),
        ...
        "use strict";
        var a = n(1);
        a.module("mwl.calendar").controller("MwlCalendarSlideBoxCtrl", ["$scope", "$timeout", "calendarConfig", "calendarEventTitle", function(e, t, n, a) {
            var r = this;
            r.calendarConfig = n, r.calendarEventTitle = a, r.isCollapsed = !0, e.$watch("vm.isOpen", function(e) {
                t(function() {
                    r.isCollapsed = !e
                })
            })
        ...
        "use strict";
        var a = n(1);
        a.module("mwl.calendar").controller("MwlCalendarWeekCtrl", ["$scope", "moment", "calendarHelper", "calendarConfig", "calendarEventTitle", function(e, t, n, a, r) {
            var i = this;
            i.showTimes = a.showTimesOnWeekView, i.calendarEventTitle = r, e.$on("calendar.refreshView", function() {
                i.dayViewSplit = i.dayViewSplit || 30, i.dayViewHeight = n.getDayViewHeight(i.dayViewStart, i.dayViewEnd, i.dayViewSplit), i.showTimes ? i.view = n.getWeekViewWithTimes(i.events, i.viewDate, i.dayViewStart, i.dayViewEnd, i.dayViewSplit) : i.view = n.getWeekView(i.events, i.viewDate)
        ...
        a.module("mwl.calendar").controller("MwlCalendarYearCtrl", ["$scope", "moment", "calendarHelper", function(e, t, n) {
            ...
            a.openMonthIndex = null, e.$on("calendar.refreshView", function() {
                a.view = n.getYearView(a.events, a.viewDate, a.cellModifier), a.cellIsOpen && null === a.openMonthIndex && (a.openMonthIndex = null, a.view.forEach(function(e) {
                    t(a.viewDate).startOf("month").isSame(e.date) && a.monthClicked(e, !0)
                }))
                ...
                if (t || (a.onTimespanClick({
                    ...
                    r === a.openMonthIndex ? (a.openMonthIndex = null,
                        a.cellIsOpen = !1) : (a.openMonthIndex = r, a.openRowIndex = Math.floor(r / 4), a.cellIsOpen = !0)
                }
        ...
        "use strict";
        var a = n(1);
        a.module("mwl.calendar").controller("MwlDragSelectCtrl", ["$scope", "$element", "$parse", "$attrs", function(e, t, n, a) {
            function r(t) {
                return function(a) {
        ...
        "use strict";
        var a = n(1);
        a.module("mwl.calendar").controller("MwlDraggableCtrl", ["$element", "$scope", "$window", "$parse", "$attrs", "$timeout", "interact", function(e, t, n, r, i, l, d) {
            function o(e, t) {
            ...
            if (d) {
                ...
                i.snapGrid && (c = r(i.snapGrid)(t), s = {
                    ...
                    snap: s,
                    onstart: function(e) {
                        a.element(e.target).addClass("dragging-active"), e.target.dropData = r(i.dropData)(t), e.target.style.pointerEvents = "none", i.onDragStart && (r(i.onDragStart)(t), t.$apply())
                    },
                    onmove: function(e) {
                        ...
                        "static" === n.getComputedStyle(l[0]).position && l.css("position", "relative"), o(l, "translate(" + d + "px, " + s + "px)").css("z-index", 50).attr("data-x", d).attr("data-y", s), i.onDrag && (r(i.onDrag)(t, {
                            x: d,
                            y: s
                        }), t.$apply())
                    },
                    onend: function(e) {
                        var n = a.element(e.target),
                            d = n.attr("data-x"),
                            s = n.attr("data-y");
                        e.target.style.pointerEvents = "auto", i.onDragEnd && (r(i.onDragEnd)(t, {
                            x: d,
                            y: s
                        }), t.$apply()), l(function() {
                            o(n, "").css("z-index", "auto").removeAttr("data-x").removeAttr("data-y").removeClass("dragging-active")
                        })
                    }
        ...
        "use strict";
        var a = n(1);
        a.module("mwl.calendar").controller("MwlDynamicDirectiveTemplateCtrl", ["$compile", "$scope", "$attrs", "$element", "$templateCache", "calendarConfig", function(e, t, n, r, i, l) {
        ...
        "use strict";
        var a = n(1);
        a.module("mwl.calendar").controller("MwlElementDimensionsCtrl", ["$element", "$scope", "$parse", "$attrs", "$window", function(e, t, n, r, i) {
            function l() {
        ...
        "use strict";
        var a = n(1);
        a.module("mwl.calendar").controller("MwlResizableCtrl", ["$element", "$scope", "$parse", "$attrs", "$timeout", "interact", function(e, t, n, r, i, l) {
            function d(e, t) {
                var n = {};
                return n.edge = e, "start" === e ? (n.x = t.data("x"), n.y = t.data("y")) : "end" === e && (n.x = parseFloat(t.css("width").replace("px", "")) - v.width, n.y = parseFloat(t.css("height").replace("px", "")) - v.height), n
            }
            if (l) {
                var o, s;
                ...
                l(e[0]).resizable({
                    ...
                    onmove: function(e) {
                        if (e.rect.width > 0 && e.rect.height > 0) {
                            ...
                            }), l += e.deltaRect.left, o += e.deltaRect.top, i.css("transform", "translate(" + l + "px," + o + "px)"), i.data("x", l), i.data("y", o), (0 !== e.deltaRect.left || 0 !== e.deltaRect.top) && (c = "start"), r.onResize && (n(r.onResize)(t, d(c, i)), t.$apply())
                        }
                    },
                    onend: function(e) {
                        var l = a.element(e.target),
        ...
        "use strict";
        var a = n(1);
        a.module("mwl.calendar").factory("calendarEventTitle", ["calendarDateFilter", "calendarTruncateEventTitleFilter", function(e, t) {
            function n(t) {
...
//+ " (" + e(t.startsAt, "time", !0) + ")"
        ...
        var a = n(1),
            r = n(3);
        a.module("mwl.calendar").factory("calendarHelper", ["$q", "$templateRequest", "dateFilter", "moment", "calendarConfig", function(e, t, n, a, i) {
            function l(e, t) {
                ...
                if (t) {
                    switch (t) {
                        ...
                        case "month":
                            ...
                            break;
                        default:
                            throw new Error("Invalid value (" + t + ") given for recurs on. Can only be year or month.")
                    }
                    i = d(e.start, r, i)
                }
                return {
            ...
            function s(e, t, n) {
                ...
                var r = o({
                    ...
                    i = r.start,
                    l = r.end;
                return i.isAfter(t) && i.isBefore(n) || l.isAfter(t) && l.isBefore(n) || i.isBefore(t) && l.isAfter(n) || i.isSame(t) || l.isSame(n)
            }
            ...
            function u() {
                for (var e = [], t = 0; 7 > t;) e.push(l(a().weekday(t++), i.dateFormats.weekDay));
                return e
            }

            function f(e, t, n) {
                for (var r = [], d = v(t, "year", e), o = a(t).startOf("year"), s = 0; 12 > s;) {
                    var u = o.clone(),
            ...
            function p(e, t, n) {
                ...
                r = i.displayAllMonthEvents ? c(e, d, o) : c(e, l, l.clone().endOf("month"));
                for (var s = [], v = a().startOf("day"); d.isBefore(o);) {
                    var u = d.month() === a(t).month(),
                        f = [];
                    (u || i.displayAllMonthEvents) && (f = c(r, d, d.clone().endOf("day")));
                    var p = {
                        label: d.date(),
                        date: d.clone(),
                        inMonth: u,
            ...
            function w(e, t) {
                for (var n = a(t).startOf("week"), d = a(t).endOf("week"), s = n.clone(), v = [], m = a().startOf("day"); v.length < 7;) v.push({
                    ...
                    events: c(e, n, d).map(function(e) {
                        var t = a(n).startOf("day"),
                            r = o({
                                ...
                                end: a(e.endsAt || e.startsAt).startOf("day").add(1, "second")
                            }, e.recursOn, t);
            ...
            function h(e, t, n, r, i) {
                ...
                return w.map(function(e) {
                    if (a(e.startsAt).isBefore(v) ? e.top = 0 : e.top = a(e.startsAt).startOf("minute").diff(v.startOf("minute"), "minutes") * f - 2, a(e.endsAt || e.startsAt).isAfter(m)) e.height = u - e.top;
                    else {
                        var t = e.startsAt;
                        a(e.startsAt).isBefore(v) && (t = v.toDate()), e.endsAt ? e.height = a(e.endsAt).diff(a(t), "minutes") * f : e.height = 30
                    }
                    ...
                    return p.forEach(function(n, a) {
                        ...
                        n.filter(function(e) {
                            ...
                            (s(e, t.startsAt, t.endsAt || t.startsAt) || s(t, e.startsAt, e.endsAt || e.startsAt)) && (r = !1)
            ...
            function g(e, t, n, i, l) {
                ...
                return d.eventRows.forEach(function(e) {
                    ...
                    var t = s.filter(function(t) {
                            return a(t.startsAt).startOf("day").isSame(a(e.date).startOf("day"))
                        }),
                        r = h(t, e.date, n, i, l);
                    o = o.concat(r)
                }), d.eventRows = [{
        ...
        a.module("mwl.calendar").factory("calendarTitle", ["moment", "calendarConfig", "calendarHelper", function(e, t, n) {
            ...
            function r(n) {
                return t.titleFormats.week.replace("{week}", e(n).isoWeek()).replace("{year}", e(n).startOf("week").format("YYYY"))
            }
